...
- **GitHub Private Vulnerability Reporting**: [신고하기](https://github.com/epicsagas/tossinvest-rs/security/advisories/new)
...
- 일반 사용 문의·버그 → GitHub [Issues](https://github.com/epicsagas/tossinvest-rs/issues)를 사용하세요.
